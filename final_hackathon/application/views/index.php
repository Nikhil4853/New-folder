...
.copyright-menu li {
  ...
  .set-top-row{background-image: linear-gradient(360deg, red, transparent);;}
  .bg-white{background-color:white;}
  .nav-link{color: rgb(217 10 10 / 72%)!important;}
  
    .searchform{height:50px!important;}
    .ftco-section{padding: 0em 0!important;}
    footer,.top-sect{font-family: -apple-system, -apple-system;}
    .set-color-lightred{color:#e44e4e;padding-right: 15px;}
    .fontsize18{font-size: 18px;margin-left: -88px;}
    .addfam{font-family: "Times New Roman", Times, serif; font-size:35px;}
    .setborder{    border: 2px solid #e44e4e;
    border-radius: 30px;}
    .sethov:hover{border: 2px solid black;}
   </style>
   </head>
   <body>
       
      <section class="ftco-section top-sect"  style="box-shadow: 0px 5px 10px 0px rgb(131 119 119 / 69%);margin-bottom:13px;">
          <div>
         ...
         <!--<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">-->
             <nav class="navbar navbar-expand-lg bg-white" id="ftco-navbar" > 
               ...
               <div class="col-md-12 text-center">
                         ...
                         <h1 class="set-color addfam" style="color:#046d73;"><b> Geo-Tagging Of Educational Institutions</b></h1>
                      </div>
                  ...
                  <div class="container">
                     <div class="col-md-12">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4 virtual_tour sethov" id="virtual_tour"><input type="hidden" id="fream" value="" /><img src="https://sirtbhopal.ac.in/hackathon/assets/icon/virtual-tour.png" width="100%" onclick="getvt()" data-toggle="modal" data-target="#vModal" style="cursor: pointer;" /></div>
      ...
      <!--website Modal -->
      <div class="modal fade" id="webModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title college_name" id="exampleModalLabel"></h5>
      ...
      <div class="custom-container set-background-color" >
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="section" style="margin-top:20px;height:700px;background-image: linear-gradient(88deg, #0f7620, transparent);">
              ...
              var url = '<?php echo base_url("index.php/map/collegedetails"); ?>';
                $.ajax({
                    ...
                    /* $("#campus_map").html("<div id='campus_map'>"+'<a href="' + data.campus_map + '"target="_blank">'+'<img src="<?php echo base_url(); ?>assets/icon/campus-map.png" width="100%"/>'+'</a>'+"</div>");*/
                     ...
                     $("#vr_pics").html("<div id='vr_pics'>"+'<a href="' + data.vr_pics + '"target="_blank">'+'<img src="<?php echo base_url(); ?>assets/icon/pics.png" width="100%"/>'+'</a>'+"</div>");                                 
      ...
      <script src="js/popper.js+bootstrap.min.js+main.js.pagespeed.jc.CkBNE38wgd.js"></script><script>eval(mod_pagespeed_KCPclvFWlk);</script>
      <script>eval(mod_pagespeed_ymehVf8unZ);</script>
      <script>eval(mod_pagespeed_CAIy$zxYJF);</script>
      <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194" integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw==" data-cf-beacon='{"rayId":"73b90a4a795c6ee9","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.6.0","si":100}' crossorigin="anonymous"></script>
   </body>
</html>